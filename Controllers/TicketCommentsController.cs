    ...
    public class TicketCommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TicketId,Comment")] TicketComment ticketComment)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Details", "Tickets",new {id = ticketComment.TicketId.ToString() });
            }
            ViewData["TicketId"] = new SelectList(_context.Tickets, "Id", "Description", ticketComment.TicketId);
            ViewData["UserId"] = new SelectList(_context.Users, "Id", "Id", ticketComment.UserId);

            return RedirectToAction("Details", "TicketsController", new { id = ticketComment.TicketId.ToString() });
        }
