...
namespace BugBurner.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,PropertyName,Description,Created,OldValue,NewValue,UserId")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,PropertyName,Description,Created,OldValue,NewValue,UserId")] TicketHistory ticketHistory)
        {
