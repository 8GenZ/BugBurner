...
namespace BugBurner.Data.Migrations
{
    ...
    [Migration("20230907153742_003-ProjectPriority")]
    partial class _003ProjectPriority
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BugBurner.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BugBurner.Models.NotificationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BugBurner.Models.ProjectPriority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BugBurner.Models.Notification", b =>
                {
                    b.HasOne("BugBurner.Models.NotificationType", "NotificationType")
                        .WithMany()
                    ...
                    b.HasOne("BugBurner.Models.BTUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BugBurner.Models.BTUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("BugBurner.Models.Project", b =>
                {
                    ...
                    b.HasOne("BugBurner.Models.ProjectPriority", "ProjectPriority")
                        .WithMany()
